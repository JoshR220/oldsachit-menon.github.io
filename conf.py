...
BLOG_AUTHOR = "Sachit Menon"  # (translatable)
BLOG_TITLE = "Sachit Menon"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://sachit-menon.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://sachit-menon.github.io/"
BLOG_EMAIL = "sachit.menon@duke.edu"
BLOG_DESCRIPTION = "A personal website mostly for explorations in computer science and math."  # (translatable)
